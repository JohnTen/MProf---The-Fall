Shader "Custom/Swaying" {
	Properties {
		...
		_Cutout("Alpha cutout", Range(0,1)) = 0.8
		_Speed("MoveSpeed", Range(20,50)) = 25 // speed of the swaying
		_Rigidness("Rigidness", Range(0.1,50)) = 25 // lower makes it look more "liquid" higher makes it look rigid
